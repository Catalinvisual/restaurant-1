...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="card card-admin m-3 shadow-sm position-relative">
      ...
      <div className="card-body d-flex flex-column justify-content-between">
        <div>
          <div className="mb-2">
            {product.isNew && (
              <span className="product-badge badge-new">Nou</span>
            )}
            {product.isPromo && (
              <span className="product-badge badge-promo">Promo</span>
            )}
          </div>
